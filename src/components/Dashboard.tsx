...
const CONTAINER_GROUP_MEMBERS: Readonly<Record<string, ContainerNameParts>> = {
  ...
  'pongdang-frontend': { application: 'pongdang', component: 'frontend' },
  'pongdang-backend': { application: 'pongdang', component: 'backend' },
  'pongdang-db': { application: 'pongdang', component: 'db' },
